...
def on_click(text, detect_language, detected_language):
    ...
    return round(score, 4), sent_scores, detected_language
    ...
    with gr.Row():
        ...
        with gr.Column(variant="panel", scale=2, min_width=100):
            ...
            language_dropdown = gr.Dropdown(
                ...
                interactive=True)
            output_score = gr.Textbox(label="Confidence", interactive=False)
        ...
        score_btn.click(fn=on_click, 
                        ...
                        outputs=[output_score, highlighted_text, detected_language])
